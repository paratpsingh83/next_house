...
// Request DTOs — exact field names from backend
...
export interface OtpRequest {
  phone?: string;
  email?: string;
  purpose: string; // REGISTRATION | LOGIN | PASSWORD_RESET | PHONE_VERIFICATION | TWO_FACTOR_AUTH
}
...
export interface ReactPostRequest {
  reactionType: string; // LIKE | HEART | HELPFUL | CELEBRATE | CURIOUS
}
...
export interface ActivityResponse {
  ...
  community?: CommunitySummaryDTO;
  neighborhood?: NeighborhoodSummaryDTO;
  myJoinStatus: string; // NONE | PENDING | APPROVED | REJECTED
  isHost: boolean;
  createdAt: string;
}
...
export interface ChatRoomResponse {
  id: number;
  roomType: string; // DIRECT | GROUP | ACTIVITY | COMMUNITY
  title?: string;
  avatarUrl?: string;
