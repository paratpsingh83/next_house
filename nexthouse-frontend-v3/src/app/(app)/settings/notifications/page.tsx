...
const PREF_KEY = 'nexthouse:notif:prefs';
    ...
    items: [
      {
        ...
        sub:       'When someone reacts to your post',
        icon:      Heart,
        iconBg:    'bg-red-100',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        sub:       'When someone requests to follow you',
        icon:      Star,
        iconBg:    'bg-amber-100',
    ...
    items: [
      {
        key:       'activities',
        label:     'Activities',
        sub:       'Join requests, approvals and updates',
        icon:      Zap,
      ...
      },
      {
        key:       'safetyAlerts',
        label:     'Safety alerts',
        sub:       'Important alerts in your neighbourhood',
        icon:      Shield,
        iconBg:    'bg-red-100',
      ...
      },
      {
        key:       'communities',
        label:     'Communities',
        sub:       'Join requests and community updates',
        icon:      Users,
...
export default function NotificationsSettingsPage() {
  ...
  const toggleAll = () => {
    const all = allOff ? DEFAULTS : ({} as NotifPrefs);
    const next = allOff
      ? { ...DEFAULTS }
      : Object.fromEntries(Object.keys(DEFAULTS).map(k => [k, false])) as NotifPrefs;
    setPrefs(next);
    savePrefs(next);
