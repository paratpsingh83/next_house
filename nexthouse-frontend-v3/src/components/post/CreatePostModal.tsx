...
export default function CreatePostModal({ user, lat, lon, onClose, onCreated }: Props) {
  ...
  const handleSubmit = async () => {
    ...
    setLoading(true);
    try {
      await postsApi.create({ postType, content, latitude: lat, longitude: lon, anonymous, mediaIds });
