...
export const usersApi = {
    ...
    getNearby: (lat: number, lon: number, radius = 5000, page = 0, size = 20) => apiGet<PageResponse<NearbyUserResponse>>('/users/nearby', {
        latitude: lat,
        longitude: lon,
        radiusMeters: radius,
        page,
    ...
    search: (query: string, page = 0, size = 20) => apiGet<PageResponse<UserSummaryDTO>>('/users/search', {
        query,
        page,
        size
    }),
    ...
    getFollowers: (userId: number, page = 0, size = 20) => apiGet<PageResponse<UserSummaryDTO>>(`/users/${userId}/followers`, {
        page,
        size
    }),
    getFollowing: (userId: number, page = 0, size = 20) => apiGet<PageResponse<UserSummaryDTO>>(`/users/${userId}/following`, {
        page,
        size
    }),
...
export const postsApi = {
    ...
    nearbyFeed: (lat: number, lon: number, radius = 5000, page = 0, size = 20) => apiGet<PageResponse<PostResponse>>('/posts/feed/nearby', {
        latitude: lat,
        longitude: lon,
        radiusMeters: radius,
        page,
    ...
    trendingFeed: (neighborhoodId: number, page = 0, size = 20) => apiGet<PageResponse<PostResponse>>('/posts/feed/trending', {
        neighborhoodId,
        page,
        size
    }),
    communityFeed: (communityId: number, page = 0, size = 20) => apiGet<PageResponse<PostResponse>>(`/posts/feed/community/${communityId}`, {
        page,
        size
    }),
    userPosts: (userId: number, page = 0, size = 20) => apiGet<PageResponse<PostResponse>>(`/posts/user/${userId}`, {
        page,
        size
    }),
    hashtagFeed: (hashtag: string, page = 0, size = 20) => apiGet<PageResponse<PostResponse>>(`/posts/hashtag/${hashtag}`, {
        page,
        size
    }),
    ...
    savedPosts: (collection?: string, page = 0, size = 20) => apiGet<PageResponse<PostResponse>>('/posts/saved', {
        collection,
        page,
        size
    }),
    ...
    // Comments
    getComments: (postId: number, page = 0, size = 20) => apiGet<PageResponse<PostCommentResponse>>(`/posts/${postId}/comments`, {
        page,
        size
    }),
    addComment: (postId: number, d: CreateCommentRequest) => apiPost<PostCommentResponse>(`/posts/${postId}/comments`, d),
    getReplies: (commentId: number, page = 0, size = 20) => apiGet<PageResponse<PostCommentResponse>>(`/posts/comments/${commentId}/replies`, {
        page,
        size
    }),
...
export const activitiesApi = {
    ...
    nearby: (lat: number, lon: number, radius = 10000, type?: string, page = 0, size = 20) => apiGet<PageResponse<ActivityResponse>>('/activities/nearby', {
        latitude: lat,
        longitude: lon,
        radiusMeters: radius,
        activityType: type,
    ...
    byCommunity: (communityId: number, page = 0, size = 20) => apiGet<PageResponse<ActivityResponse>>(`/activities/community/${communityId}`, {
        page,
        size
    }),
    ...
    getMembers: (id: number, joinStatus = 'APPROVED', page = 0, size = 20) => apiGet<PageResponse<ActivityMemberResponse>>(`/activities/${id}/members`, {
        joinStatus,
        page,
        size
    }),
...
export const communitiesApi = {
    ...
    nearby: (lat: number, lon: number, radius = 10000, page = 0, size = 20) => apiGet<PageResponse<CommunityResponse>>('/communities/nearby', {
        latitude: lat,
        longitude: lon,
        radiusMeters: radius,
        page,
    ...
    search: (query: string, page = 0, size = 20) => apiGet<PageResponse<CommunityResponse>>('/communities/search', {
        query,
        page,
        size
    }),
    ...
    getMembers: (id: number, role?: string, page = 0, size = 20) => apiGet<PageResponse<UserSummaryDTO>>(`/communities/${id}/members`, {
        role,
        page,
        size
    }),
...
export const neighborhoodsApi = {
    detect: (lat: number, lon: number) => apiGet<NeighborhoodSummaryDTO>('/neighborhoods/detect', {
        latitude: lat,
        longitude: lon
    }),
    get: (id: number) => apiGet<NeighborhoodSummaryDTO>(`/neighborhoods/${id}`),
    nearby: (lat: number, lon: number, limit = 5) => apiGet<PageResponse<NeighborhoodSummaryDTO>>('/neighborhoods/nearby', {
        latitude: lat,
        longitude: lon,
        limit
    }),
...
export const chatApi = {
    ...
    getHistory: (roomId: number, page = 0, size = 30) => apiGet<PageResponse<ChatMessageResponse>>(`/chat/rooms/${roomId}/messages`, {
        page,
        size
    }),
...
export const notificationsApi = {
    getAll: (unreadOnly = false, page = 0, size = 20) => apiGet<PageResponse<NotificationResponse>>('/notifications', {
        unreadOnly,
        page,
        size
    }),
...
export const marketplaceApi = {
    ...
    nearby: (lat: number, lon: number, radius = 10000, category?: string, minPrice?: number, maxPrice?: number, page = 0, size = 20) =>
        apiGet<PageResponse<MarketplaceItemResponse>>('/marketplace/nearby', {
            latitude: lat,
            longitude: lon,
            radiusMeters: radius,
            category,
    ...
    search: (query: string, page = 0, size = 20) => apiGet<PageResponse<MarketplaceItemResponse>>('/marketplace/search', {
        query,
        page,
        size
    }),
...
export const safetyApi = {
    ...
    byNeighborhood: (neighborhoodId: number, page = 0, size = 20) => apiGet<PageResponse<SafetyAlertResponse>>(`/safety-alerts/neighborhood/${neighborhoodId}`, {
        page,
        size
    }),
    nearby: (lat: number, lon: number, radius = 5000, page = 0, size = 20) => apiGet<PageResponse<SafetyAlertResponse>>('/safety-alerts/nearby', {
        latitude: lat,
        longitude: lon,
        radiusMeters: radius,
        page,
...
export const searchApi = {
    ...
    users: (query: string, page = 0, size = 20) => apiGet<PageResponse<UserSummaryDTO>>('/search/users', {
        query,
        page,
        size
    }),
    posts: (query: string, page = 0, size = 20) => apiGet<PageResponse<PostResponse>>('/search/posts', {
        query,
        page,
        size
    }),
    activities: (query: string, page = 0, size = 20) => apiGet<PageResponse<ActivityResponse>>('/search/activities', {
        query,
        page,
        size
    }),
    communities: (query: string, page = 0, size = 20) => apiGet<PageResponse<CommunityResponse>>('/search/communities', {
        query,
        page,
        size
    }),
    marketplace: (query: string, page = 0, size = 20) => apiGet<PageResponse<MarketplaceItemResponse>>('/search/marketplace', {
        query,
        page,
        size
    }),
...
export const borrowApi = {
    ...
    byNeighborhood: (neighborhoodId: number, status?: string, page = 0, size = 20) => apiGet<PageResponse<BorrowRequestResponse>>(`/borrow-requests/neighborhood/${neighborhoodId}`, {
        status,
        page,
        size
    }),
...
export const recommendationsApi = {
    ...
    activities: (page = 0, size = 20) => apiGet<PageResponse<ActivityResponse>>('/recommendations/activities', {
        page,
        size
    }),
    communities: (page = 0, size = 20) => apiGet<PageResponse<CommunityResponse>>('/recommendations/communities', {
        page,
        size
    }),
